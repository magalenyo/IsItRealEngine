...
void UIHierarchy::RenderRecursively(GameObject* gameObject)
{
    if (gameObject != nullptr) {
        ...
        if (gameObject->IsLeaf()) {
            node_flags |= ImGuiTreeNodeFlags_Leaf | ImGuiTreeNodeFlags_NoTreePushOnOpen; // ImGuiTreeNodeFlags_Bullet
            ImGui::TreeNodeEx((void*) gameObject, node_flags, "%s", gameObject->GetName().c_str());
            if (ImGui::IsItemClicked())
            ...
            bool node_open = ImGui::TreeNodeEx((void*) gameObject, node_flags, "%s", gameObject->GetName().c_str());
            if (ImGui::IsItemClicked())
                clickedNode = gameObject;
            if (ImGui::BeginDragDropSource())
            {
